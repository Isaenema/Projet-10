...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // Transmet la nouvelle valeur au lieu de simplement appeler onChange()
    setValue(newValue);
    setCollapsed(true); // `setCollapsed(true)` pour fermer le menu après sélection
  };
